...
const postSummariesIdEnrollment = (req, res) => {
    ...
    const query = `INSERT INTO summary_enrollments (user_id, summary_id, enrollment_date)
                   VALUES ?`;
...
const postCourseIdEnrollment = (req, res) => {
    ...
    const query = `INSERT INTO course_enrollments (user_id, course_id, enrollment_date)
                   VALUES ?`;
...
const postTransaction = (req, res) => {
    const {payment_methods_id} = req.body;
    const {user_id} = req.params;
