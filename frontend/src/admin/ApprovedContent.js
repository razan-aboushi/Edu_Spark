...
function ApprovedContent() {
    ...
    return (
        <div className="container mt-5 text-center mb-5 radius">
            <div className="tabs mb-4 fw-bold">
                <button
            ...
            {activeTab === 1 && totalCoursePages > 1 && (
                <ul className="pagination justify-content-center">
                    {pageNumbersCourses.map((pageNumber) => (
                        <li key={pageNumber}
                            className={`page-item ${currentCoursePage === pageNumber ? 'active' : ''}`}>
            ...
            {activeTab === 2 && totalSummaryPages > 1 && (
                <ul className="pagination justify-content-center">
                    {pageNumbers.map((pageNumber) => (
                        <li key={pageNumber}
                            className={`page-item ${currentSummaryPage === pageNumber ? 'active' : ''}`}>
