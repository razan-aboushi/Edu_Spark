...
function CheckoutPayment() {
    ...
    // get the user data to autofill the phone number
    useEffect(() => {
                                                        ...
                                                        <div className="col-lg-12">
                                                            <div className="cardPay shadow">
                                                                <div className="card-body p-4">
                                                                    <h4>تفاصيل الدفع:</h4>
                                                                    <p>المجموع
                                                                        الفرعي: {parseFloat(subtotal).toFixed(1)} د.أ</p>
                                                                    <p>إجمالي
                                                                        المبلغ: {parseFloat(total).toFixed(1)} د.أ</p>
                                                                    <p>
                                                                        سيتم إضافة رسوم رمزية "15%" ستكون شاملة ضريبة
                                                                        القيمة المُضافة نشكر تعاونكم.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <form onSubmit={handleFormSubmit} id="cardForm">
                                                            ...
                                                            <div className="row mb-3">
                                                                <div className="col-lg-6 col-md-6 col-sm-12">
                                                                    <label className="form-label">تاريخ إنتهاء البطاقة
                                                                        (MM/YYYY)</label>
                                                                    <input
                                                                        type="tel"
                                                                        name="expiry"
