        ...
        <>
                                        ...
                                        <div className="row justify-content-end">
                                            <div className="col-sm-10 col-lg-8">
                                                ...
                                                <p className="text-white mb-3 pb-2">
                                                    احصل على مُلخصات مواد الجامعة الخاصة بك
                                                </p>
                                                <div className="d-flex justify-content-end">
                                                    <Link to="/Summaries">
                                                        <button
                                                            className="btn-primary rounded-pill px-5 py-2 animated slideInUp">
                                                            المُلخصات
                                                        </button>
                                                    </Link>
                                                </div>
            ...
            <div dir="rtl" style={{marginTop: "110px", textAlign: "center"}}>
                <section className="card123">
                    ...
                    <div
                        className="container d-flex align-items-center justify-content-center position-relative flex-wrap">
                    ...
                    <div className="row gy-4">
                            ...
                            <div
                                ...
                                <div className="accordion-item">
                                    ...
                                    <div
                                        ...
                                        <div className="accordion-body mt-2">
                                            ...
                                            . إنه منصة تعليمية توفر شروحات لطلاب الجامعة في مراحل مختلفة، وتقدمها الطالب
                                            كمعلم للمتعلم، من خلال تقديم وشرح الملخصات. وتوفر مواد لجامعات مختلفة في
                                            أكثر من فئة واحدة.
                                ...
                                <div className="accordion-item">
                                    ...
                                    <div
                                        ...
                                        data-bs-parent="#faqlist">
                                        <div className="accordion-body mt-2">
                                            يمكنك الدفع للمواد والملخصات من خلال صفحة الدفع على الموقع عند النقر على
                                            المادة المطلوبة.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item">
                                    ...
                                    <div
                                        ...
                                        data-bs-parent="#faqlist">
                                        <div className="accordion-body mt-2">
                                            نعم، يمكنك إضافة ملخصات أو مواد للبيع أو مجانًا على الموقع، بالإضافة إلى
                                            القدرة على إضافة أسئلة ومصارف اختبار للعديد من المواد. وسيتم خصم نسبة من
                                            المال كرسوم عند البيع عبر الموقع.
                                        </div>
                                    </div>
                                </div>
                                {/* # بند الأسئلة المتكررة */}
                                ...
                                <div className="accordion-item">
                                    ...
                                    <div
                                        ...
                                        data-bs-parent="#faqlist">
                                        <div className="accordion-body mt-2">
                                            في تفاصيل عرض كل دورة أو مُلخص يوجد البريد الإلكتروني و الفيسبوك و لينكد إن
                                            للشخص الناشر لهما أي المُعلم "الطالب" الذي يقوم بتقديمهما ، يمكنك التواصل
                                            معه من خلال النقر على أي واحدة منهم و التواصل معه
                                        </div>
                                    </div>
                                </div>
                                {/* # بند الأسئلة المتكررة */}
                        ...
                        <div className="col-lg-4 order-lg-2 order-1 ">
                            <div className="content px-xl-5">
                                ...
                                <p>
                                    هل لديك سؤال في ذهنك؟ هنا يمكنك العثور على أجوبة لأسئلتك المختلفة ، إذا كنت ترغب في
                                    رؤية المزيد من <HashLink to="/faq/#">الأسئلة الشائعة</HashLink>، وإذا واجهت أي
                                    ابتعاد، نحن هنا من أجلك.
                                    <br/>
                                    <HashLink
                                        to={"/contact/#"}
