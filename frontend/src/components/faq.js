              ...
              <div className="col-lg-12 order-lg-1 order-2">
                ...
                <div
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header">
                      <button
                        ...
                        كيف يمكنني الدفع لشراء المُلخصات والكتب؟
                      </button>
                    </h3>
                    <div
                      id="faq-content-1"
                      ...
                      <div className="accordion-body mt-4">
                         يمكنك الدفع للمواد والملخصات من خلال صفحة الدفع في الموقع عند النقر على المادة المطلوبة و القيام بإضافتها للسلة بعد تسجيل الدخول إلى الموقع و إتمام عملية الشراء.                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body mt-4">
                        نعم، يمكنك إضافة ملخصات أو مواد للبيع أو مجانًا على الموقع. وسيتم خصم نسبة من المال كرسوم عند البيع عبر الموقع.
                      </div>
                    </div>
                  </div>
                  {/* # فقرة الأسئلة المتكررة */}
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body mt-4">
                        نعم ، يمكنك طباعة الملف بصيغة PDF ، ولكن بعد أن تدفع مقابل هذه الخدمة "أن يتم دفع سعر الملخص حتى و لو كان مجاناً ف يجب إتمام العملية" ة. 
                      </div>
                    </div>
                  </div>
                  {/* # فقرة الأسئلة المتكررة */}
                  <div className="accordion-item">
                    <h3 className="accordion-header">
                      ...
                      >
                        ...
                        ما هي التخصصات المتاحة في الموقع؟
                      </button>
                    </h3>
                    <div
                      id="faq-content-7"
                    ...
                    >
                      <div className="accordion-body mt-4">
                        هناك العديد من التخصصات المتعلقة بالكليات في الجامعات المختلفة
                      </div>
                    </div>
                  </div>
                  {/* # فقرة الأسئلة المتكررة */}
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body mt-4">
                        تختلف الأوقات من دورة إلى أخرى حسب حجمها وحسب ما يحدده الشخص الذي يقوم بشرحها .
                      </div>
                    </div>
                  </div>
                  {/* # فقرة الأسئلة المتكررة */}
